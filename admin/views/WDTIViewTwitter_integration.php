...
class WDTIViewTwitter_integration{
  ...
  ?>
    <div style="float: right; text-align: right;">
        <a style="display: inline-block; color: red; text-decoration: none;" target="_blank" href="http://web-dorado.com/files/fromTwitterIntegrationWP.php">
          <img width="215" border="0" alt="web-dorado.com" src="<?php echo WD_WDTI_URL . '/images/pro.png'; ?>" />
        </a>
    </div>
    <form class="wrap" id="spider_twitt_form" method="post" action="admin.php?page=twitter_integration" style="width:95%;">
      ...
      <div class="tablenav top">
        <?php
        WDWTILibrary::search('Title', $search_value, 'spider_twitt_form');
        WDWTILibrary::html_page_nav($page_nav['total'], $page_nav['limit'], 'spider_twitt_form');
        ?>
      </div>
 ...
 <form class="wrap" method="post" id="spider_twitt__form" action="admin.php?page=twitter_integration" style="width:95%;">
   ...
   <div class="wdti_type_div_conteiner">
     <div class="wdti_type_div_content">
       ...
       <div id="tweetbutton_menu" class="wdti_type_span" onclick="spider_twitt_change_type('tweetbutton')" >
         <span>Tweet</span>
       </div>
       <div id="followbutton_menu" class="wdti_type_span" onclick="spider_twitt_change_type('followbutton')" style="right:3px" >
         <span>Follow</span>
       </div>
       <div id="timeline_menu" class="wdti_type_span" style="right:6px" >
         <span>Widget</span>
       </div>
       <div id="mention_menu" class="wdti_type_span" onclick="spider_twitt_change_type('mention')" style="right:9px" >
         <span>Mention</span>
       </div>
       <div id="hashtag_menu" class="wdti_type_span" onclick="spider_twitt_change_type('hashtag')" style="right:12px" >
         <span>Hashtag</span>
       </div>
     </div>
   </div>
