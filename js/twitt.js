...
function spider_twitt_change_type (type) {
	...
	jQuery("#tweetbutton_menu,#followbutton_menu,#timeline_menu,#mention_menu,#hashtag_menu").css({
		'background-color':'#c2c2c2'
	});
	jQuery("#tweetbutton_menu span,#followbutton_menu span,#timeline_menu span,#mention_menu span,#hashtag_menu span").css({
		'color':'#7a7a7a'
	});
	jQuery("#"+type+"_menu").css({
		'background-color':'#2da9e3'
	});
	jQuery("#"+type+"_menu span").css({
		'color':'#ffffff'
	});
